...
#define GEPARD_ID       0x103B8716
#define UNIQUE_ID_XOR	0x5928EA37
#define SRAND_CONST		0x1837EE27
#define POS_1_START		0x52
#define POS_2_START		0x66
#define RAND_1_START	0xB0
#define RAND_2_START	0x47
